...
export const myProjects = [
  {
    title: 'SympToDialog - AI chatbot for healthcare',
    desc: 'Developed an AI-powered chatbot for healthcare provider training, enhancing diagnostic skills in sensitive STI conversations, using JavaScript, Node.js, and OpenAI API for realistic dialogue generation.',
    subdesc:
    ...
    href: 'https://github.com/anonymousegoose/symptodialogue',
...
export const workExperiences = [
  {
    id: 1,
    name: 'Coding Mind Academy',
    pos: 'Programming Instructor',
    duration: '2024 - Present',
    title: "I teach K-12 students foundational coding and hardware skills by leading engaging project-based workshops in Circuit Python. By fostering a creative learning environment, I inspire students to explore real-world applications of STEM concepts and build innovative solutions.",
  ...
  },
  {
    ...
    pos: 'Math and Computer Science Instructor',
    duration: '2024 - Present',
    title: "Innovation Academy inspires young minds in S.T.E.A.M. education. As a teacher, I guide students in computer science, fostering problem-solving, creativity, and collaboration through an engaging curriculum.",
  ...
  },
  {
    ...
    pos: 'Sales Associate',
    duration: '2019 - 2023',
    title: "As a Macy's Retail Sales Associate, I deliver exceptional customer service by utilizing product knowledge to meet sales goals, assisting with digital orders, and maintaining a welcoming shopping experience.",
